...
%   confidence level if using CVaR). It utilizes a perturbed probability 
%   distribution to evaluate the robustness of the original policy, which
%   was trained on unperturbed probabilities. 
% INPUTS:
...
function [] = Plot_Perturbed_Histograms(scenarioID, configurationID, x0) 
    ...
    for j = 1:length(confidence_levels_to_evaluate)
        ...
        generate_histograms(scenarioID, configurationID, x0, l0, true); 
